        ...
        <main className="px-6 sm:px-10 md:px-20">
            ...
            <section className='flex flex-col lg:grid lg:grid-cols-2 gap-4 lg:gap-6 mt-6'>
                <article className="bg-rose-100 p-4 rounded-xl">
                    <h3 className="text-3xl mt-4">Make Transfer</h3>
                ...
                <aside className="border border-gray-100 p-4 rounded-xl">
                <h3 className="text-3xl text-gray-700 mt-4">Recent Transfers</h3>

                <ul className='h-[400px] md: flex flex-col gap-3 overflow-y-scroll'>
                    <PastTransaction 
                    reciepient='Mary Adewale'
                    email='mary@interswitch.com'
                    amount={46000}
                    time='13 hours'
                    />
                    <PastTransaction 
                    reciepient='John Adetunde'
                    email='john@interswitch.com'
                    amount={46000}
                    time='13 hours'
                    />
                    <PastTransaction 
